...
public final class UpdateWithoutWhereRule implements MigrationRule {

    @Override
    public boolean supports(SqlStatement statement) {
        return statement != null && statement.type() == StatementType.UPDATE;
    }
    ...
    public List<Finding> analyze(SqlStatement statement, AnalysisContext context) {
        ...
        return List.of(new Finding(
                ...
                statement.startLine(),
                statement.rawSql(),
                "UPDATE statement does not contain a WHERE clause.",
                "This operation may modify every row in the target table.",
